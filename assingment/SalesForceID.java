...
public class SalesForceID {
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//input[@name='Name']")).sendKeys("Deepanilavazhagan");
		...
		String text = driver.findElement(By.xpath("//lightning-formatted-text[text()='Deepanilavazhagan']")).getText();
		if (text.equals("Deepanilavazhagan")) {
